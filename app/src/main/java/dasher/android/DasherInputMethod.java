    		...
    		intf.enqueue(new Runnable() {
	    		public void run() {
	    			for (int all=e.getSwitchChanges(); all!=0;) {
	    	    		...
	    	    		int keyId;
	    	    		switch (sw) {
	    	    			case SwitchEvent.MASK_SWITCH_J1: //case 10: //up
	    	    				keyId = 4;
	    	    				break;
	    	    			case SwitchEvent.MASK_SWITCH_J2: //case 20: //down
	    	    				keyId = 2;
	    	    				break;
	    	    			case SwitchEvent.MASK_SWITCH_J3: //case 40: //right
	    	    				keyId = 4; // -> forward
	    	    				break;
	    	    			case SwitchEvent.MASK_SWITCH_J4: //case 80: //left
	    	    				keyId = 1; // -> back
	    	    				break;
	    	    			case SwitchEvent.MASK_SWITCH_E1:
	    	    				keyId = 4;
	    	    				break;
	    	    			case SwitchEvent.MASK_SWITCH_E2:
	    	    				keyId = 2;
	    	    				break;
	        				default:
